...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FPBTokenizer/FPBTokenizer.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FPHIFPBExtractoriOS/FPBExtractoriOS.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FPHISDKSelphiComponent/selphiComponent.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FPHISDKStatusComponent/statusComponent.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FPHISDKTokenizeComponent/tokenizeComponent.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FPHISDKTrackingComponent/trackingComponent.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FPHISDKVideoIDComponent/videoidComponent.framework"
fi
