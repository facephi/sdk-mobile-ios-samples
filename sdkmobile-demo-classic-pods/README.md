...
Aplicación demo para testear internamente todos los componentes de la SDK Mobile con captura facial y de documento, descargando los componentes desde nuestros repositorios privados (Artifactory). 
