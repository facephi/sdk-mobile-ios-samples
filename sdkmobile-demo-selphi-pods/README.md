...
Aplicación demo para testear internamente todos los componentes de la SDK Mobile con captura de biometría facial, descargando los componentes desde nuestros repositorios privados (Artifactory). 
