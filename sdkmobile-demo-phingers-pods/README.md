# SDK-Mobile Cocoapods Demo Phingers Version

Aplicación demo para testear internamente todos los componentes de la SDK Mobile con lector de huellas, descargando los componentes desde nuestros repositorios privados (Artifactory). 
