# SDK-Mobile Cocoapods Demo Voice Version

Aplicación demo para testear internamente todos los componentes de la SDK Mobile con identificación por voz, descargando los componentes desde nuestros repositorios privados (Artifactory). 
