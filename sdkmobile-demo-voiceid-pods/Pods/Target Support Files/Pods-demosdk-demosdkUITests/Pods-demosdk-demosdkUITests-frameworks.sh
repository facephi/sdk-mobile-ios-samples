...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FPHISDKVoiceIDComponent/voiceIDComponent.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FPHIVoiceSDK/VoiceSdk.framework"
fi
