 ...
 * Base functions.
 *
 * This header defines the create and destroy functions for basic types.
 */
 ...
 */
TOKENIZER_BINDING_C_PUBLIC char *CreateString(uint64_t size);
 ...
 */
TOKENIZER_BINDING_C_PUBLIC void DestroyString(char **string);
 ...
 */
TOKENIZER_BINDING_C_PUBLIC float *CreateFloatArray(uint64_t size);
 ...
 */
TOKENIZER_BINDING_C_PUBLIC void DestroyFloatArray(float **array);
 ...
 * @return Created array on the heap.
 */
TOKENIZER_BINDING_C_PUBLIC double *CreateDoubleArray(uint64_t size);
 ...
 * @param array Array to destroy.
 */
TOKENIZER_BINDING_C_PUBLIC void DestroyDoubleArray(double **array);
 ...
 * @return Created array on the heap.
 */
TOKENIZER_BINDING_C_PUBLIC uint8_t *CreateByteArray(uint64_t size);
 ...
 * @param array Array to destroy.
 */
TOKENIZER_BINDING_C_PUBLIC void DestroyByteArray(uint8_t **array);
 ...
 * @return Created array on the heap.
 */
TOKENIZER_BINDING_C_PUBLIC int16_t *CreateShortArray(uint64_t size);
 ...
 * @param array Array to destroy.
 */
TOKENIZER_BINDING_C_PUBLIC void DestroyShortArray(int16_t **array);
 ...
 * @return Created array on the heap.
 */
TOKENIZER_BINDING_C_PUBLIC int *CreateIntArray(uint64_t size);
 ...
 * @param array Array to destroy.
 */
TOKENIZER_BINDING_C_PUBLIC void DestroyIntArray(int **array);
