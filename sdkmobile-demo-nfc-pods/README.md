...
Aplicación demo para testear internamente todos los componentes de la SDK Mobile con lector de NFC, descargando los componentes desde nuestros repositorios privados (Artifactory). 
