# SDK-Mobile Demo Classic+VideoRecording Version

Aplicación demo para testear internamente todos los componentes de la SDK Mobile con videograbación, captura facial y de documento, descargando los componentes desde nuestros repositorios privados (Artifactory). 
